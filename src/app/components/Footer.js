                ...
                <div className={footerStyles.content}>
                    <div className={footerStyles.top}>
                        ...
                        <div className={footerStyles[`media-icons`]}>
                            ...
                            <Link href="https://www.instagram.com/the_ansariii/?hl=en" target="_blank"><i > <FaInstagram/>  </i></Link>
                            <Link href="https://www.linkedin.com/in/rehaan-ansari" target="_blank"><i > <FaLinkedinIn /> </i></Link>
                            <Link href="https://github.com/rehaanansari811" target="_blank"><i > <FaGithub />  </i></Link>
                        </div>
                    </div>
                ...
                <div className={footerStyles['bottom-details']}>
                    <div className={footerStyles.bottom_text}>
                        <span className={footerStyles.copyright_text}> Copyright © 2023
                            <Link href="/>"> Movie Flix.</Link> All rights reserved </span>
